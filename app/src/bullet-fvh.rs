...
//        lr_scheduler: lr::StepLR { start: 0.001, gamma: 0.1, step: 18 },
    ...
    let settings = LocalSettings { threads: 32, test_set: None, output_directory: "checkpoints", batch_queue_size: 64 };

    // loading directly from a `BulletFormat` file
    let data_loader = loader::DirectSequentialDataLoader::new(&["/home/folkert/combined.dat"]);
