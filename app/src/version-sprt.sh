...
echo "-concurrency 6 -each tc=8+0.08 book=/home/folkert/bin/data/dc-3200.bin -rounds 9000 -games 2 -bookmode disk -recover -pgnout dinges.pgn -site 'cutechess' -sprt elo0=0 elo1=10 alpha=0.05 beta=0.05" >> versions/sprt.sh
